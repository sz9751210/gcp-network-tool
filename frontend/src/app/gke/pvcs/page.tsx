        ...
        <div className="p-8 max-w-[1800px] mx-auto">
            <div className="flex flex-col gap-2 mb-8">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-lg">
                    Monitor PersistentVolumeClaims and storage utilization
                </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-12 shadow-sm">
                <div className="flex flex-col items-center justify-center text-center max-w-md mx-auto">
                    ...
                    <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-2">
                        PVCs View Coming Soon
                    </h2>
                    <p className="text-slate-500 dark:text-slate-400">
                        Detailed visualization of persistent storage claims, disk bindings, and health.
                    </p>
                </div>
            </div>
        </div>
