                    ...
                    <table className="w-full text-left border-collapse text-sm">
                        <thead>
                            <tr className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-800">
                                ...
                                <th className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Storage Class</th>
                        ...
                        <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                            {paginated.map((pvc, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <Badge variant={pvc.status === 'Bound' ? 'emerald' : pvc.status === 'Pending' ? 'amber' : 'red'} pill>
                                            {pvc.status}
                                        </Badge>
                                    </td>
                ...
                {selectedPVC && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg flex flex-col gap-1 border border-slate-200 dark:border-slate-800">
                                <div className="text-xs text-slate-500 uppercase">Access Modes</div>
                        ...
                        <div className="space-y-4">
                            <div>
                                <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-2">Volume Information</h4>
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-2">Location</h4>
                        ...
                        <div className="flex items-center gap-2 p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                            ...
                            <span className="text-xs text-indigo-700 dark:text-indigo-300 font-medium">Associated Persistent Volume link Coming Soon</span>
                        </div>
                    </div>
                )}
            </SlideOver>
...
export default function GKEPvcsPage() {
    return (
        <Suspense fallback={<div className="p-8 text-center text-slate-500">Loading PVCs...</div>}>
            <GKEPvcsContent />
        </Suspense>
    );
}
